    ...
    <div classNameName="container" style={myStyle}>
      ...
      <div className="accordion" id="accordionExample">
        ...
        <div className="accordion-item">
            ...
            <button className="accordion-button" style={myStyle} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseOne">
                Accordion Item #2
            </button>
            </h2>
